...
def test_opreturn(client):
    inp1 = messages.TxInputType(
        address_n=parse_path("44h/1h/1h/0/21"),  # myGMXcCxmuDooMdzZFPMmvHviijzqYKhza
        amount=89_581,
    ...
    assert_tx_matches(
        serialized_tx,
        hash_link="https://btc1.trezor.io/api/tx/c3185a82c0328304adfb52bfd07d4bca2c34f13153b32d9d034390365c46bbd2",
