...
class TrezorctlGroup(click.Group):
    ...
    def get_command(self, ctx: click.Context, cmd_name: str) -> Optional[click.Command]:
        ...
        try:
            ...
            return super().get_command(ctx, command).get_command(ctx, subcommand)  # pyright: ignore ["get_command" is not a known member of "None";;Cannot access member "get_command" for type "Command"]
        except Exception:
            pass
